<%-- 
    Document   : reportAjax
    Created on : 25 Nov, 2017, 12:07:35 PM
    Author     : UMESH-ADMIN
--%>
...
<%
    ...
    String[] dt=Utils.DbFmt.format(new Date()).split("-");
    cal.set(Calendar.YEAR, new Integer(dt[0]));
    cal.set(Calendar.MONTH, new Integer(dt[1]));
    
    Date begDate=Utils.DbFmt.parse(dt[0]+"-"+dt[1]+"-01");
    Date finDate=Utils.DbFmt.parse(dt[0]+"-"+dt[1]+"-"+cal.getActualMaximum(Calendar.DATE));
    System.out.println(begDate+" "+finDate);
    if(t.equals("M-FIN")){
...
<!--<div class="loginForm">
    ...
    <h2 class="white nopadding nomargin">Performance</h2><hr>-->
<div class="fullWidWithBGContainer ">
    ...
    <div class="fullWidWithBGContainer ">
        ...
        <%
                ...
                + "sum(disc),sum(bal),refBy from DistSaleManager dsm  group by refBy order by NW desc)").list();
