...
import mvc.service.DistributionRecordService;
 ...
 */
@Controller
@RequestMapping(value = "/distributionRecord")
public class DistributionRecordController {
   
    @Autowired
    DistributionRecordService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DistributionRecord e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DistributionRecord e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        DistributionRecord e = service.get(id);
        if(e==null)
