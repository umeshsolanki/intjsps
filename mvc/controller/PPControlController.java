...
import mvc.service.PPControlService;
 ...
 */
@Controller
@RequestMapping(value = "/pPControl")
public class PPControlController {
   
    @Autowired
    PPControlService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody PPControl e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody PPControl e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
