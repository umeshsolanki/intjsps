...
import mvc.service.BranchTransferService;
...
public class BranchTransferController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody BranchTransfer e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody BranchTransfer e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        BranchTransfer e = service.get(id);
        if(e==null)
