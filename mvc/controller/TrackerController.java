...
import mvc.service.TrackerService;
...
public class TrackerController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Tracker e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Tracker e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
