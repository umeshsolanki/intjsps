...
import mvc.service.DistSaleManagerService;
 ...
 */
@Controller
@RequestMapping(value = "/distSaleManager")
public class DistSaleManagerController {
   
    @Autowired
    DistSaleManagerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DistSaleManager e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DistSaleManager e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        DistSaleManager e = service.get(id);
        if(e==null)
