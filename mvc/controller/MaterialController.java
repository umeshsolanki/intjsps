...
import mvc.service.MaterialService;
...
public class MaterialController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Material e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Material e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
