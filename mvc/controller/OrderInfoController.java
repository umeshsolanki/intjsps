...
import mvc.service.OrderInfoService;
...
public class OrderInfoController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody OrderInfo e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody OrderInfo e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
