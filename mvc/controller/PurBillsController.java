...
import mvc.service.PurBillsService;
 ...
 */
@Controller
@RequestMapping(value = "/purBills")
public class PurBillsController {
   
    @Autowired
    PurBillsService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody PurBills e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody PurBills e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
