...
import mvc.service.BillService;
...
public class BillController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Bill e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Bill e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
