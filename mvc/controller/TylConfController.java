...
import mvc.service.TylConfService;
 ...
 */
@Controller
@RequestMapping(value = "/tylConf")
public class TylConfController {
   
    @Autowired
    TylConfService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody TylConf e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody TylConf e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
