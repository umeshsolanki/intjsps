...
import mvc.service.OrdersBackupService;
 ...
 */
@Controller
@RequestMapping(value = "/ordersBackup")
public class OrdersBackupController {
   
    @Autowired
    OrdersBackupService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody OrdersBackup e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody OrdersBackup e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
