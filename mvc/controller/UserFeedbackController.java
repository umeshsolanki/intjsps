...
import mvc.service.UserFeedbackService;
...
public class UserFeedbackController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody UserFeedback e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody UserFeedback e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
