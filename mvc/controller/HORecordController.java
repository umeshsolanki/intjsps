...
import mvc.service.HORecordService;
 ...
 */
@Controller
@RequestMapping(value = "/hORecord")
public class HORecordController {
   
    @Autowired
    HORecordService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody HORecord e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody HORecord e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
