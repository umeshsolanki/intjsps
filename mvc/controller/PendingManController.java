...
import mvc.service.PendingManService;
 ...
 */
@Controller
@RequestMapping(value = "/pendingMan")
public class PendingManController {
   
    @Autowired
    PendingManService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody PendingMan e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody PendingMan e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
