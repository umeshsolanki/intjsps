...
import mvc.service.CourierRecordService;
 ...
 */
@Controller
@RequestMapping(value = "/courierRecord")
public class CourierRecordController {
   
    @Autowired
    CourierRecordService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody CourierRecord e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody CourierRecord e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        CourierRecord e = service.get(id);
        if(e==null)
