...
import mvc.service.FinishedProductService;
...
public class FinishedProductController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody FinishedProduct e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody FinishedProduct e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        FinishedProduct e = service.get(id);
        if(e==null)
