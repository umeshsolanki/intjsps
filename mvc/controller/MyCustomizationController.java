...
import mvc.service.MyCustomizationService;
...
public class MyCustomizationController {
   
    @Autowired
    MyCustomizationService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody MyCustomization e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody MyCustomization e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        MyCustomization e = service.get(id);
        if(e==null)
