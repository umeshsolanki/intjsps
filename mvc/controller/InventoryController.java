...
import mvc.service.InventoryService;
...
public class InventoryController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Inventory e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Inventory e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
