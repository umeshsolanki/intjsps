...
import mvc.service.SKUChangeListenerService;
 ...
 */
@Controller
@RequestMapping(value = "/sKUChangeListener")
public class SKUChangeListenerController {
   
    @Autowired
    SKUChangeListenerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody SKUChangeListener e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody SKUChangeListener e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        SKUChangeListener e = service.get(id);
        if(e==null)
