...
public class CustomerController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Customer e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Customer e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
