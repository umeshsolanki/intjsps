...
import mvc.service.BarcodeService;
...
public class BarcodeController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Barcode e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Barcode e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
