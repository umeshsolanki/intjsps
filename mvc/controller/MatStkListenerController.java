...
import mvc.service.MatStkListenerService;
 ...
 */
@Controller
@RequestMapping(value = "/matStkListener")
public class MatStkListenerController {
   
    @Autowired
    MatStkListenerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody MatStkListener e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody MatStkListener e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        MatStkListener e = service.get(id);
        if(e==null)
