...
import mvc.service.VendorService;
...
public class VendorController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Vendor e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Vendor e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
