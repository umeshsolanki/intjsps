...
import mvc.service.StockManagerService;
...
public class StockManagerController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody StockManager e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody StockManager e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
