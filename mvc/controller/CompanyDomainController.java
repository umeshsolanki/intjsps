...
import mvc.service.CompanyDomainService;
 ...
 */
@Controller
@RequestMapping(value = "/companyDomain")
public class CompanyDomainController {
   
    @Autowired
    CompanyDomainService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody CompanyDomain e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody CompanyDomain e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        CompanyDomain e = service.get(id);
        if(e==null)
