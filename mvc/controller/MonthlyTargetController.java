...
import mvc.service.MonthlyTargetService;
...
public class MonthlyTargetController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody MonthlyTarget e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody MonthlyTarget e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        MonthlyTarget e = service.get(id);
        if(e==null)
