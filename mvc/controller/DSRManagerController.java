...
import mvc.service.DSRManagerService;
 ...
 */
@Controller
@RequestMapping(value = "/dSRManager")
public class DSRManagerController {
   
    @Autowired
    DSRManagerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DSRManager e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DSRManager e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
