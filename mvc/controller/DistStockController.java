...
import mvc.service.DistStockService;
 ...
 */
@Controller
@RequestMapping(value = "/distStock")
public class DistStockController {
   
    @Autowired
    DistStockService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DistStock e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DistStock e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
