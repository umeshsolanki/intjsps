...
import mvc.service.ProductionBranchService;
 ...
 */
@Controller
@RequestMapping(value = "/productionBranch")
public class ProductionBranchController {
   
    @Autowired
    ProductionBranchService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody ProductionBranch e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody ProductionBranch e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        ProductionBranch e = service.get(id);
        if(e==null)
