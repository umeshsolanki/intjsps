...
import mvc.service.MaterialConsumedService;
 ...
 */
@Controller
@RequestMapping(value = "/materialConsumed")
public class MaterialConsumedController {
   
    @Autowired
    MaterialConsumedService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody MaterialConsumed e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody MaterialConsumed e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        MaterialConsumed e = service.get(id);
        if(e==null)
