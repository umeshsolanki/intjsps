...
import mvc.service.InwardManagerService;
 ...
 */
@Controller
@RequestMapping(value = "/inwardManager")
public class InwardManagerController {
   
    @Autowired
    InwardManagerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody InwardManager e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody InwardManager e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        InwardManager e = service.get(id);
        if(e==null)
