...
import mvc.service.TaxRecService;
 ...
 */
@Controller
@RequestMapping(value = "/taxRec")
public class TaxRecController {
   
    @Autowired
    TaxRecService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody TaxRec e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody TaxRec e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
