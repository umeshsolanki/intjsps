...
import mvc.service.ConfigService;
...
public class ConfigController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Config e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Config e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
