...
import mvc.service.FPSTKListenerService;
 ...
 */
@Controller
@RequestMapping(value = "/fPSTKListener")
public class FPSTKListenerController {
   
    @Autowired
    FPSTKListenerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody FPSTKListener e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody FPSTKListener e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        FPSTKListener e = service.get(id);
        if(e==null)
