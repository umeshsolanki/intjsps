...
public class SKUController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody SKU e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody SKU e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
