...
import mvc.service.RepairRecordService;
...
public class RepairRecordController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody RepairRecord e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody RepairRecord e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
