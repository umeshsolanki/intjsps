...
import mvc.service.CustReturnsService;
 ...
 */
@Controller
@RequestMapping(value = "/custReturns")
public class CustReturnsController {
   
    @Autowired
    CustReturnsService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody CustReturns e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody CustReturns e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
