...
import mvc.service.MaterialStockListenerService;
 ...
 */
@Controller
@RequestMapping(value = "/materialStockListener")
public class MaterialStockListenerController {
   
    @Autowired
    MaterialStockListenerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody MaterialStockListener e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody MaterialStockListener e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        MaterialStockListener e = service.get(id);
        if(e==null)
