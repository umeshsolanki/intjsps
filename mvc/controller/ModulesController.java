...
import mvc.service.ModulesService;
...
public class ModulesController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Modules e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Modules e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
