...
import mvc.service.TransferRecordService;
...
public class TransferRecordController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody TransferRecord e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody TransferRecord e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        TransferRecord e = service.get(id);
        if(e==null)
