...
import mvc.service.FinishedProductStockService;
 ...
 */
@Controller
@RequestMapping(value = "/finishedProductStock")
public class FinishedProductStockController {
   
    @Autowired
    FinishedProductStockService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody FinishedProductStock e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody FinishedProductStock e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        FinishedProductStock e = service.get(id);
        if(e==null)
