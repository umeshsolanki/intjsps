...
import mvc.service.SlrPndRecService;
 ...
 */
@Controller
@RequestMapping(value = "/slrPndRec")
public class SlrPndRecController {
   
    @Autowired
    SlrPndRecService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody SlrPndRec e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody SlrPndRec e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
