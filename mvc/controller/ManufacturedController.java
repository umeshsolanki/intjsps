...
import mvc.service.ManufacturedService;
...
public class ManufacturedController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Manufactured e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Manufactured e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
