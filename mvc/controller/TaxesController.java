...
import mvc.service.TaxesService;
...
public class TaxesController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Taxes e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Taxes e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
