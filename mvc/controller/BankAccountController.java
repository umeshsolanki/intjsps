...
import mvc.service.BankAccountService;
...
public class BankAccountController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody BankAccount e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody BankAccount e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
