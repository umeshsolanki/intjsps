...
import mvc.service.UIManagerService;
 ...
 */
@Controller
@RequestMapping(value = "/uIManager")
public class UIManagerController {
   
    @Autowired
    UIManagerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody UIManager e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody UIManager e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
