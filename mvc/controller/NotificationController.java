...
import mvc.service.NotificationService;
...
public class NotificationController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Notification e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Notification e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
