...
import mvc.service.DSRBottomService;
 ...
 */
@Controller
@RequestMapping(value = "/dSRBottom")
public class DSRBottomController {
   
    @Autowired
    DSRBottomService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DSRBottom e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DSRBottom e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
