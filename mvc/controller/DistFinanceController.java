...
import mvc.service.DistFinanceService;
 ...
 */
@Controller
@RequestMapping(value = "/distFinance")
public class DistFinanceController {
   
    @Autowired
    DistFinanceService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DistFinance e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DistFinance e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
