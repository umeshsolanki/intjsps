...
import mvc.service.ActivityTracerService;
 ...
 */
@Controller
@RequestMapping(value = "/activityTracer")
public class ActivityTracerController {
   
    @Autowired
    ActivityTracerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody ActivityTracer e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody ActivityTracer e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        ActivityTracer e = service.get(id);
        if(e==null)
