...
import mvc.service.FinanceRequestService;
 ...
 */
@Controller
@RequestMapping(value = "/financeRequest")
public class FinanceRequestController {
   
    @Autowired
    FinanceRequestService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody FinanceRequest e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody FinanceRequest e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        FinanceRequest e = service.get(id);
        if(e==null)
