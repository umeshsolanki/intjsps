...
import mvc.service.ProductionRequestService;
...
public class ProductionRequestController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody ProductionRequest e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody ProductionRequest e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        ProductionRequest e = service.get(id);
        if(e==null)
