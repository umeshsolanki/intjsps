...
import mvc.service.AdminsService;
...
public class AdminsController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Admins e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Admins e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
