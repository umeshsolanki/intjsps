...
import mvc.service.SaleInfoService;
...
public class SaleInfoController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody SaleInfo e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody SaleInfo e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
