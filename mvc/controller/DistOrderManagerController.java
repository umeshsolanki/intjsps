...
import mvc.service.DistOrderManagerService;
 ...
 */
@Controller
@RequestMapping(value = "/distOrderManager")
public class DistOrderManagerController {
   
    @Autowired
    DistOrderManagerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DistOrderManager e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DistOrderManager e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        DistOrderManager e = service.get(id);
        if(e==null)
