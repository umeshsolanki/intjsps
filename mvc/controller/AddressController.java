...
public class AddressController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody Address e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody Address e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
