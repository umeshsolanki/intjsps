...
import mvc.service.DistStockListenerService;
 ...
 */
@Controller
@RequestMapping(value = "/distStockListener")
public class DistStockListenerController {
   
    @Autowired
    DistStockListenerService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody DistStockListener e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody DistStockListener e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        DistStockListener e = service.get(id);
        if(e==null)
