...
import mvc.service.LenDenService;
 ...
 */
@Controller
@RequestMapping(value = "/lenDen")
public class LenDenController {
   
    @Autowired
    LenDenService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody LenDen e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody LenDen e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
