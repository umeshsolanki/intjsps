...
import mvc.service.ReturnInfoService;
...
public class ReturnInfoController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody ReturnInfo e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody ReturnInfo e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
