...
import mvc.service.PendingJobListService;
 ...
 */
@Controller
@RequestMapping(value = "/pendingJobList")
public class PendingJobListController {
   
    @Autowired
    PendingJobListService service;
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody PendingJobList e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody PendingJobList e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
    ...
    public String delete(HttpSession session, @PathVariable("id") Long id){
        PendingJobList e = service.get(id);
        if(e==null)
