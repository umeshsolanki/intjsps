...
import mvc.service.COBFService;
 ...
 */
@Controller
@RequestMapping(value = "/cOBF")
public class COBFController {
    ...
    @ResponseBody
    public String save(HttpSession session,@RequestBody COBF e){
        service.save(e);
        return "Saved";
    }
    ...
    @ResponseBody
    public String edit(HttpSession session, @RequestBody COBF e, @PathVariable("id") Long id){
        service.update(e);
        return "Updated";
    }
