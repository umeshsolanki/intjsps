...
<div class="">
    ...
    <div class="fullWidWithBGContainer">
        <div class="" >
            <span class="white"><h2 class="nopadding nomargin">Raw Material Opening</h2></span><hr>
        <br>
    <center>
        <form action="FormManager " method="post" name="loginForm" id='loginForm' >
            <input type="hidden"  name="action" id="action" value="Mopening"/>
            <input type="date" class="textField" name="dt" id="dt" value="<%=Utils.DbFmt.format(new Date())%>"/>
