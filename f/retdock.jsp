...
<div class="loginForm" style="background-color: #ababbc;max-width: 100%;">
    ...
    <div class="fullWidWithBGContainer bgcolef">
        <h2 class="nomargin nopadding bgcolt8 centAlText">Return Details <%=o.getDocketNo()%></h2><hr>
        <br>
    <center>
        <form action="FormManager " method="post" name="ef" id='ef' >
            <input type="hidden" name="action" id="action" value="salereturn"/>
            ...
            <input class="textField" type="text" id="iboy" name="iboy" value="" placeholder="Received  by"/><br>
                <%
                ...
                <p class="greenFont nomargin spdn">Courier Details</p>
                    ...
                    <input class="textField" value="" type="text" id="ddt" name="ddt" onfocus="(this.type='date');" onblur="(this.type='text');" placeholder="Return  Date"/>
                    <input class="textField" value="" type="text" id="delDtt" name="deldt" onfocus="(this.type='date');" onblur="(this.type='text');" placeholder="Received on"/>
                    <%}%>
                    <br><br>
            <button onclick='return subForm("ef","U");' id="editBtn" class="button">Save</button><br>
            <br><br>
        </form>
    </center>
</div>
