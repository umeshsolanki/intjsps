...
<div class="">
    ...
    <center>
        <div class="half left">
            <span class="white"><h2 class="nopadding nomargin">Update Product Stock</h2></span><hr>
        <br>
    ...
    <div class="half right">
        <span class="white"><h2 class="nomargin nopadding">Update Material Stock</h2></span><hr>
        <br>
