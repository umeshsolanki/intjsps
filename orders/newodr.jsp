...
//                                        alert(obj['id']);
                                ...
                                <select style='vertical-align:top;height:70px' multiple name='taxes"+prodCount+"'>"+taxes+"</select>\
...
//                            showMes();
        ...
        var req={sno:$("#sno").val(),to:$("#to").val(),by:$("#by").val(),r1:$("#r1").val(),r2:$("#r2").val(),ref:$("#ref").val(),cPin:$("#cPIN").val(),cApt:$("#cApt").val(),exps:exps,dis:$("#sel").val(),dt:$("#dt").val(),
...
//        showMes(JSON.stringify(req));
    ...
    <div class="fullWidWithBGContainer">
        <h2 class="centAlText nomargin nopadding white">New Order</h2><hr>
    <center>
        <form action="FormManager" onsubmit="return false;" method="post" name="loginForm" id='loginForm' >
                    ...
                    <select id="ref" class="textField" name="ref">
                        ...
                        <option value="<%=r.getDisId().split("00R-")[1]%>"><%=r.getDisId().split("00R-")[1]%></option>
                        <%}%>
                    </select>
                    ...
                    <!--<input class="textField" type="text"  id="to" name="to" placeholder="To/Distributor Id"/>-->
                        ...
                        <input class="textField" type="text"  id="instChg" name="instChg" title="Service Charge" placeholder="Serv. Charge To be collected"/>
