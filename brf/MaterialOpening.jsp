...
<div class="">
    ...
    <div class="fullWidWithBGContainer">
        <div class="half left" >
            <span class="white"><h2 class="centAlText nopadding nomargin">Material Opening</h2></span><hr>
        <br>
    <center>
    ...
    <div class="half right" >
        <span class="white"><h2 class="nopadding nomargin">Recent Entries</h2></span><hr>
