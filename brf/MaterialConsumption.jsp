...
Admins role=(Admins)session.getAttribute("role");
    ...
    List<MaterialConsumed> prods=sess.createQuery("from MaterialConsumed mc where mc.branch=:br order by mc.consumeId desc").setParameter("br", role.getBranch()).list();
    
  
    %>

    <div>
        <span class="white"><h2>Material Consumption <%=role.getBranch().getBrName()%></h2></span>
    <hr><br>
