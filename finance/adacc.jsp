...
<div class="loginForm" style="background-color: #ababbc;max-width: 100%;">
    ...
    <div class="fullWidWithBGContainer">
            ...
            <span class="white"><h2 class="nomargin nopadding centAlText">New Account</h2></span><hr>
        <br>
    <center>
        <form action="FormManager " method="post" name="loginForm" id='finForm' >
            <input type="hidden" name="action" id="action" value="newacc"/>
            <input class="textField" type="text" id="acc"  name="acc" placeholder="Account No"/>
            <input class="textField" type="text" id="bknm" name="bNm" placeholder="Bank Name"/><br>
            <input class="textField" type="text" id="bkNm" name="bLoc" placeholder="Bank Location"/>
            <input class="textField" type="text" id="ifsc" name="ifsc" placeholder="IFSC"/><br><br>
