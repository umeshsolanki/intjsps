    ...
    <body>
        ...
        <nav>
            <div class="nav-wrapper">
              <a href="#!" class="brand-logo">&nbsp;&nbsp; Pullandry</a>
              <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
              <ul class="right hide-on-med-and-down">
                  <li><a href="${ctx}/api/admin/home">Home</a></li>
                  <li><a href="${ctx}/api/product/new">Products</a></li>
                <li><a href="${ctx}/api/cart">My Cart</a></li>
        ...
        <ul class="sidenav" id="mobile-demo">
          ...
          <li><a href="${ctx}/api/product/new">Products</a></li>
          <li><a href="${ctx}/cart.jsp">My Cart</a></li>
          <li><a class="modal-trigger" href="#login" >Login</a></li>
          <li><a href="${ctx}/contact.jsp">Contact US</a></li>
        </ul>
        <script>
