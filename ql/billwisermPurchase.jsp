...
//    InwardManager
    List<Object[]> pendings = sess.createQuery("select sum(price) as ttl,billNo from InwardManager group by billNo order by ttl desc")
            .list();
%>
    <hr>
    <%
...
//    }
    ...
    <table border="1px solid" cellpadding="2px">
        <thead>
            ...
            <%
            List<InwardManager> im=sess.createQuery("from InwardManager order by billNo desc").list();
