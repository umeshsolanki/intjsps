...
%>
    ...
    <div class="fullWidWithBGContainer bgcolt8">
        ...
        <div class="subNav left bgcolef">
            <p class="nomargin nopadding white bgcolt8">Report Links</p><hr>
            <ul>
                <li>
                    <form id="dtfil"><br>
                        <input type="date" class="textField" value="<%=Utils.DbFmt.format(dt[0])%>" name="id"/><br>
                        <input type="date" class="textField" value="<%=Utils.DbFmt.format(dt[1])%>" name="fd"/>
                    </form><br>
                </li><hr>
                <li class="navLink leftAlText" onclick="loadPageIn('linkLoader','df/r/stock.jsp?'+gfd('dtfil'),false)">Stock report<span class="right "> <i class="fa fa-angle-double-right"></i></span></li><hr>
                <li class="navLink leftAlText" onclick="loadPageIn('linkLoader','df/r/saleKPI.jsp?'+gfd('dtfil'),false)">Sale Report<span class="right "> <i class="fa fa-angle-double-right"></i></span></li><hr>
                <li class="navLink leftAlText" title="" onclick="loadPageIn('linkLoader','df/r/fin.jsp?'+gfd('dtfil'),false)">Profit Loss<span class="right "><i class="fa fa-angle-double-right"></i></span></li><hr>
                <li class="navLink leftAlText" title="" onclick="loadPageIn('linkLoader','df/fin/pendingdock.jsp?'+gfd('dtfil'),false)">Pending Report<span class="right "><i class="fa fa-angle-double-right"></i></span></li><hr>
<!--                <li class="navLink leftAlText" title="" onclick="loadPageIn('linkLoader','df/fin/payableRec.jsp?'+gfd('dtfil'),false)">Receivable Report<span class="right "><i class="fa fa-angle-double-right"></i></span></li>-->
            </ul>
        </div>
        <div class="sbnvLdr right bgcolef" id="linkLoader">
            <p>Product Stock</p>
