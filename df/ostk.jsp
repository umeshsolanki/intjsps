...
<div style="max-width: 100%;">
    ...
    <center>
        <%if(LU==null||(LU!=null&&LU.getRoles().matches(".*\\(CStk\\).*"))){
//        if()
        %>
    <div class="">
    <span class="white"><h2 class="nopadding nomargin">Opening Stock</h2></span><hr>
        <br>
        <form action="U" class="borderRight" method="post" name="loginForm" id='osf' >
            <input type="hidden" name="action"  id="action" value="udstk"/><br>
            <input type="hidden" name="t"  id="action" value="o"/>
            ...
            <button onclick='return subForm("osf","U")' id="editBtn" class="button">Save</button>
        </form>
        <br><br>
    </div>
            <%}%>
