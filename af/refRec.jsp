...
<div class="loginForm" style="background-color: #f14cd1;max-width: 100%;">
    <span class="close" id="close" onclick="clrLSP();">x</span>
    <div class="fullWidWithBGContainer">
        <span class="white"><h2 class="nomargin nopadding centAlText">'<%=r%>' Referrer Record</h2></span><hr>
    <center>
        <table border='1px' cellpadding='2'>
            ...
            <%
            List<DistSaleManager> fd=sess.createCriteria(DistSaleManager.class).add(Restrictions.eq("refBy", r)).list();
