...
<div class="loginForm" style="background-color: #ababbc;max-width: 100%;">
    <span class="close" id="close" onclick="clrRSP();">x</span>
    <div class="fullWidWithBGContainer">
        
            <span class="white"><h2 class="nomargin nopadding centAlText">Pay Bal for <%=o.getDocketNo()%></h2></span><hr>
        <br>
    <center>
        <form action="FormManager " method="post" name="balFM" id='balFM' >
            <input type="hidden" name="action" id="action" value="updDBal"/>
            <input type="hidden" name="dsmId" id="action" value="<%=oId%>"/>
...
<input class="textField" type="text" id="payId" disabled="true" name="txn" placeholder="Txn-Id/DD/Cheque No.*"/><br>
            ...
            <input class="textField" type="number" id="amt" name="newBal" value="<%=o.getBal()%>" placeholder="Amount"/>
            <input class="textField" type="number" id="sc" name="sc" ondblclick="this.enabled=true;" <%=o.getInstCharge()>0?"disabled":""%> value="<%=o.getInstCharge()%>" placeholder="Service Charge*"/><br>
            <input class="textField" type="number" id="ref" name="ref" value="" placeholder="Refund"/>
            <br><!--
