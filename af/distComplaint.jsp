...
//    showMes(JSON.stringify(req));
    ...
    function showPopUp(smId,bal,dkt,iKm,fKm){
        ...
        <div id="oProds">
            <h2 class="nopadding nomargin">Recent Complaints</h2><hr>
                <div class=" scrollable">
                    ...
                    cellpadding="0" cellspacing="0" border="1px" style="border-color: black;font-size: 13px;">
                        <tr align="center" id="oProds"><th style="width: 50px;">Date</th><th>Docket</th>
                            ...
                            <th>Action</th></tr>
            <%
        List<DistSaleManager> stk=sess.createQuery("from DistSaleManager where dist=:d and docketNo like '3%' order by SMId desc")
...
<!--                    <td><%=odr.getSaleRecord()%></td>-->
                    ...
                    <td style="max-width: 120px;">
                        ...
                        <%}else{%>
                        <%if(odr.getExeDate()!=null)out.print("<span class='navLink' onclick='loadPage(\"distForms/DSR.jsp?dkt="+odr.getDocketNo()+"\");'>"+new SimpleDateFormat("dd.MM.yy").format(odr.getExeDate())+"</span>");%>
                        <%}%>
                    </td>
                </tr>
