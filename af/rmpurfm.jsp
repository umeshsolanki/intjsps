    ...
    <span class="close fa fa-close" id="close" onclick="clrLSP()"></span>
        ...
        <form id="importMaterial" onsubmit="return false;">
            <br><br>
                ...
                <%}%>
                <!--<input onselect="showUnits(this.value)" class="textField" name="mat" list="mts"/>-->
            ...
            <datalist id="rmSel" style="display: none;">
                <%
                List<Vendor> slrs=sess.createCriteria(Vendor.class).list();
//                Query("select distinct(purFrom) from InwardManager").list();
                for(Vendor s:slrs){%>
            ...
            <input class="textField" type="text" id="total"  name="total" placeholder="Total amount"/>
